    ...
    componentDidUpdate(prevProps, prevState) {
       ...
       //IF CART CHANGED OR SUPPLIER DETAIL SI FIRST CALLED, RECALC TOTALS
        ...
        if ((!_.isEqual(lastCart, thisCart) && !!this.props.supplierDetail) || !_.isEqual(this.props.supplierDetail, prevProps.supplierDetail)) {
            ...
            let total = 0;
            thisCart.cart.forEach(item => item.price ? total = total + item.price*item.quantity : total = total)


            this.setState({

                orderTotal: total + this.props.supplierDetail.deliveryFee,
                deliveryFee: this.props.supplierDetail.deliveryFee
